...
pl = read_json_without_bom('SteamDB Get All games with Success\JSON\PL.json')
sil = read_json_without_bom('SteamDB Get All games with Success\JSON\SIL.json')
achievement = read_json_without_bom('SteamDB Get All games with Success\JSON\Achievement.json')
...
with open('SteamDB Get All games with Success\JSON\PL_SIL.json', 'w', encoding='utf-8') as pl_sil_file:
...
with open('SteamDB Get All games with Success\JSON\AchievementFinal.json', 'w', encoding='utf-8') as achievement_final_file:
